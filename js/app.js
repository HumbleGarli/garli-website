        ...
        try {
            ...
            if (socialContainer && config.socialLinks) {
                const socialIcons = {
                    ...
                    zalo: '<svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.562 14.063c-.054.135-.225.27-.495.405-.27.135-.72.27-1.35.405-.63.135-1.395.203-2.295.203-.9 0-1.665-.068-2.295-.203-.63-.135-1.08-.27-1.35-.405-.27-.135-.441-.27-.495-.405-.054-.135-.081-.315-.081-.54V9.477c0-.225.027-.405.081-.54.054-.135.225-.27.495-.405.27-.135.72-.27 1.35-.405.63-.135 1.395-.203 2.295-.203.9 0 1.665.068 2.295.203.63.135 1.08.27 1.35.405.27.135.441.27.495.405.054.135.081.315.081.54v4.046c0 .225-.027.405-.081.54zM15.75 8.25h-7.5v1.5h5.625L8.25 15v.75h7.5v-1.5H10.125L15.75 9V8.25z"/></svg>',
